...
import { BrandingAssetController, FilePlatformController, WorkspaceFileController } from "./file-platform.controller.ts";
...
@Global()
@Module({
  controllers: [FilePlatformController, WorkspaceFileController, BrandingAssetController],
  providers: [
    {
