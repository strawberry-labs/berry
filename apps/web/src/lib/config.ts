...
const SsoConnectionConfigSchema = z.object({
  ...
  slug: z.string().default("identity-provider"),
  displayName: z.string(),
  status: z.string(),
  issuer: z.string().nullable().default(null),
  ssoUrl: z.string().nullable().default(null),
  metadataUrl: z.string().nullable().default(null),
  ...
  lastTestedAt: z.string().datetime({ offset: true }).nullable().default(null),
