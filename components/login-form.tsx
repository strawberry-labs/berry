...
import { guestSignIn, oauthSignIn } from "@/app/(auth)/actions"
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onClick={handleAppleSignIn}>
                    <path
