...
export const BerryIcon = ({ size = 16, className = "" }: { size?: number; className?: string }) => {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 270.3 403.48"
      className={`${className}`}
      xmlns="http://www.w3.org/2000/svg"
    >
      <defs>
        <style>{`.cls-1{fill:#68bc53;}.cls-2{fill:#d81e53;}`}</style>
      </defs>
      <g>
        <g>
          <path className="cls-2" d="M137.75,125.98c20.94,0,41.88-.12,62.82.04,17.11.12,32.52,5.26,45.35,16.88,13.48,12.22,21.08,27.66,23.48,45.59,2.36,17.61-.1,34.91-5.01,51.78-13.6,46.74-34.11,90.03-65.3,127.8-7.34,8.89-15.66,16.73-25.09,23.45-24.63,17.57-57.92,14.67-79.62-1.53-12.51-9.33-22.67-20.86-31.88-33.33-27.54-37.31-46.64-78.64-58.28-123.42C0,217.03-1.37,200.51,1.56,183.81c5.89-33.53,34.62-57.76,68.71-57.82,22.49-.04,44.99,0,67.48,0Z"/>
          <path className="cls-1" d="M124.86,92.23c-13.79-23.37-29.48-45.04-52.42-60.2-.33.27-.65.54-.98.8.75.93,1.47,1.88,2.25,2.79,15.72,18.24,29.13,37.92,37.45,60.72,1.27,3.48,2.33,7.03,3.48,10.55.67,2.06-.17,3.35-2.19,3.64-10.64,1.55-21.22,1.97-31.43-2.28-8.38-3.48-14.5-9.55-19.25-17.12-5.71-9.09-9.16-19.15-12.77-29.17-5.83-16.18-11.76-32.32-17.76-48.43-1.44-3.71-2.31-5.1-5.02-9.89,1.2-.2,2.38-.2,3.16-.2,17.82.45,35.65,1,52.92,6.1,11.56,3.42,22.48,8.13,31.09,17.04,5.51,5.7,9.43,12.34,11.71,19.89.56,1.86.81,4.12.29,5.94-3.37,11.73-2.85,23.39.03,35.09.35,1.42.34,2.93.5,4.41-.35.1-.69.21-1.04.31Z"/>
          <path className="cls-1" d="M232.94.05c-21.57.75-42.57,4.23-62.42,13.12-15.21,6.81-28.21,16.43-36.3,31.3-9.26,17.02-9.77,34.21,1.09,50.96.67,1.03,1.62,1.87,2.82,3.23.96-1.62,1.66-2.68,2.25-3.8,2.36-4.43,4.61-8.92,7.05-13.31,9.19-16.55,20.18-31.71,34.98-43.72,4.11-3.34,9.07-5.63,13.65-8.4.52-.23.74-.23,1.1-.35-.18.32-.26.63-.55.95-1.19,1.18-2.31,2.43-3.57,3.52-21.22,18.33-35.89,40.8-43.14,68.01-.65,2.42-.25,3.96,2.18,4.76,4.31,1.43,8.54,3.18,12.94,4.21,12.83,3,23.76-.46,32.05-10.79,3.49-4.35,6.81-9.07,9.1-14.12,4.69-10.32,8.99-20.86,12.82-31.53,6.46-18.03,13.01-35.98,23.28-52.3.27-.44.37-.99.66-1.78-3.59,0-6.79-.1-9.98.02Z"/>
        </g>
        <g>
          <ellipse cx="66.44" cy="168.07" rx="4.13" ry="7.83"/>
          <ellipse cx="204.17" cy="168.07" rx="4.13" ry="7.83"/>
          <ellipse cx="135.15" cy="162.04" rx="4.13" ry="7.83"/>
          <ellipse cx="65.23" cy="287.87" rx="4.13" ry="7.83"/>
          <ellipse cx="204.17" cy="287.72" rx="4.13" ry="7.83"/>
          <ellipse cx="135.15" cy="287.87" rx="4.13" ry="7.83"/>
          <ellipse cx="105.49" cy="347.61" rx="4.13" ry="7.83"/>
          <ellipse cx="165.25" cy="347.61" rx="4.13" ry="7.83"/>
          <ellipse cx="39.6" cy="227.9" rx="4.13" ry="7.83"/>
          <ellipse cx="105.49" cy="227.91" rx="4.13" ry="7.83"/>
          <ellipse cx="165.25" cy="227.91" rx="4.13" ry="7.83"/>
          <ellipse cx="230.75" cy="227.94" rx="4.13" ry="7.83"/>
        </g>
      </g>
    </svg>
  );
...
export const GmailIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      width={size*1.1}
      height={size*1.1}
      ...
      rx="15%"
      fill="#ffffff"/> */}
      <path d="M158 391v-142l-82-63V361q0 30 30 30" fill="#4285f4"/><path d="M 154 248l102 77l102-77v-98l-102 77l-102-77" fill="#ea4335"/><path d="M354 391v-142l82-63V361q0 30-30 30" fill="#34a853"/><path d="M76 188l82 63v-98l-30-23c-27-21-52 0-52 26" fill="#c5221f"/><path d="M436 188l-82 63v-98l30-23c27-21 52 0 52 26" fill="#fbbc04"/></svg>);
  }
...
export const OutlookIcon = ({ size = 16 }: { size?: number }) => {
  ...
  export const YahooIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      width={size}
      height={size}
