...
import { useComposedRefs } from "@berry/desktop-ui/lib/compose-refs";
  ...
  return (
    ...
    >
      <DndContext
        ...
        modifiers={modifiers ?? config.modifiers}
        sensors={sensors}
        {...(sortableProps as DndContextProps)}
        id={id}
...
function SortableContent(props: SortableContentProps) {
  ...
  const resolvedStrategy = strategyProp ?? context.strategy;
...
function SortableOverlay(props: SortableOverlayProps) {
  ...
  const resolvedModifiers = overlayModifiers ?? context.modifiers;
  ...
  return ReactDOM.createPortal(
    <DragOverlay
      {...restOverlayProps}
      dropAnimation={overlayDropAnimation ?? dropAnimation}
      {...(resolvedModifiers ? { modifiers: resolvedModifiers } : {})}
