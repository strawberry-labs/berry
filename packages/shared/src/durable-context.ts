...
export const DurableContextConfigSchema = z.object({
  ...
  turnMaxModelIterations: EnvPositiveIntegerSchema.default(12),
  turnMaxToolCalls: EnvPositiveIntegerSchema.default(48),
  turnMaxTotalTokens: EnvPositiveIntegerSchema.default(250000),
  turnMaxSpendMicros: EnvPositiveIntegerSchema.default(1000000),
  turnMaxWallTimeSeconds: EnvPositiveIntegerSchema.default(1800),
...
export function durableContextConfigFromEnv(env: Record<string, string | undefined>): DurableContextConfig {
  return DurableContextConfigSchema.parse({
    ...
    turnMaxModelIterations: env.BERRY_TURN_MAX_MODEL_ITERATIONS,
    turnMaxToolCalls: env.BERRY_TURN_MAX_TOOL_CALLS,
    turnMaxTotalTokens: env.BERRY_TURN_MAX_TOTAL_TOKENS,
    turnMaxSpendMicros: env.BERRY_TURN_MAX_SPEND_MICROS,
    turnMaxWallTimeSeconds: env.BERRY_TURN_MAX_WALL_TIME_SECONDS,
