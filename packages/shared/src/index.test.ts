...
describe("AgentStreamEventSchema", () => {
  ...
  it("parses every event kind in the turn vocabulary", () => {
    const events: AgentStreamEvent[] = [
      ...
      { kind: "question.reminded", questionId: "question_1", reminderCount: 1 },
      { kind: "question.expired", questionId: "question_1" },
      { kind: "approval.reminded", approvalId: "approval_1", reminderCount: 1 },
      { kind: "approval.expired", approvalId: "approval_1" },
      {
        kind: "provider.attempt",
        logicalStepId: "step_1",
        physicalAttempt: 1,
      ...
      { kind: "finalization.start", runId: "turn_1", operationKey: "turn_1:finalization" },
      {
        kind: "finalization.end",
        runId: "turn_1",
        operationKey: "turn_1:finalization",
        status: "complete",
        itemCount: 1,
        completedCount: 1,
        failedCount: 0,
      },
      { kind: "finalization.error", runId: "turn_1", operationKey: "turn_1:finalization", errorClass: "ProviderError" },
