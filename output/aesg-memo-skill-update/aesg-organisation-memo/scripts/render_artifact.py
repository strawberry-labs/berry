...
def main() -> int:
    ...
    # pdftoppm overwrites current pages but leaves higher-numbered pages from
    # earlier renders behind when the revised document is shorter.
    for page in output_dir.glob("page-*.png"):
        if page.stem.removeprefix("page-").isdigit() and (page.is_file() or page.is_symlink()):
            page.unlink()
